...
const Footer = ({ isDarkMode }) => {
  ...
  return (
    <footer className={`footer ${isDarkMode ? 'dark' : 'light'} overflow-x-hidden min-w-[100%] shadow-lg rounded-lg`}>
      <div className="flex flex-wrap flex-col justify-center md:flex-row md:justify-evenly min-w-full min-h-10 p-4 mx-1 mt-3 element">
        <div className="flex flex-wrap flex-col justify-center md:flex-row md:justify-evenly m-5">
          <div className="flex flex-wrap flex-col justify-center text-left max-w-[25%] h-auto text-black font-semibold m-3 p-3">
            <Link
              to="/"
